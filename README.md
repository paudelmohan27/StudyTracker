...
| Service  | URL |
|----------|-----|
| Frontend | [https://studytracker.vercel.app](https://studytracker.vercel.app) *(update after deploy)* |
| Backend  | [https://studytracker-api.onrender.com](https://studytracker-api.onrender.com) *(update after deploy)* |
